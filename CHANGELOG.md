...
## [3.21.0](https://github.com/techthiyanes/phoenix/compare/arize-phoenix-v3.20.0...arize-phoenix-v3.21.0) (2024-04-12)


### Features

* Add `phoenix.evals` bridge to `phoenix` and add `evals` extra install ([#2389](https://github.com/techthiyanes/phoenix/issues/2389)) ([d8b9054](https://github.com/techthiyanes/phoenix/commit/d8b905457c38edce247b2fb2368d90db242f3abc))
* Add `response_format` argument to `MistralAIModel` ([#2660](https://github.com/techthiyanes/phoenix/issues/2660)) ([7da51af](https://github.com/techthiyanes/phoenix/commit/7da51afc77984925cd59d7d909142141530684cc))
* add arize-phoenix support for python 3.12 ([#2555](https://github.com/techthiyanes/phoenix/issues/2555)) ([aac0cd5](https://github.com/techthiyanes/phoenix/commit/aac0cd5b3e7367fb1e791bad3bf80345520b75ea))
* add metadata to spans and traces table ([#2339](https://github.com/techthiyanes/phoenix/issues/2339)) ([e9725a2](https://github.com/techthiyanes/phoenix/commit/e9725a29c7b70fa6470eb542c57b99f20af74704))
* add phoenix-evals support for python 3.12 ([#2554](https://github.com/techthiyanes/phoenix/issues/2554)) ([efb6a76](https://github.com/techthiyanes/phoenix/commit/efb6a764a2aaecfff271b2cd7b7569771989a6a1))
* change docker base image to distroless ([#2708](https://github.com/techthiyanes/phoenix/issues/2708)) ([89d6fe7](https://github.com/techthiyanes/phoenix/commit/89d6fe7bfba0f8cc4feb791f6018cbd59a13a640))
* delete project ui ([#2593](https://github.com/techthiyanes/phoenix/issues/2593)) ([7708805](https://github.com/techthiyanes/phoenix/commit/770880567d299fc146bf343000e3cdb7e466cf99))
* Deprecate `datasets` module, rename to `inferences` ([#2785](https://github.com/techthiyanes/phoenix/issues/2785)) ([4987ea3](https://github.com/techthiyanes/phoenix/commit/4987ea37b1b9417f0c3b8d5fa7d4b4c8659b7503))
* Enable dynamic project switching ([#2537](https://github.com/techthiyanes/phoenix/issues/2537)) ([0ef3224](https://github.com/techthiyanes/phoenix/commit/0ef3224169b95210c0b2c85333309b1a3539b4d4))
* **evals:** Add Mistral as an eval model ([#2640](https://github.com/techthiyanes/phoenix/issues/2640)) ([c13ab6b](https://github.com/techthiyanes/phoenix/commit/c13ab6bf644ec285c37e92cc6a7b114a309cec52))
* experimental span storage with append-only text files ([909672b](https://github.com/techthiyanes/phoenix/commit/909672b1f2fd5f10a2cda9833abf4e3eb02b02eb))
* experimental span storage with append-only text files ([#2553](https://github.com/techthiyanes/phoenix/issues/2553)) ([909672b](https://github.com/techthiyanes/phoenix/commit/909672b1f2fd5f10a2cda9833abf4e3eb02b02eb))
* **gql:** add trace count to gql project ([#2484](https://github.com/techthiyanes/phoenix/issues/2484)) ([91b4ae1](https://github.com/techthiyanes/phoenix/commit/91b4ae16a4dc6146e1f5d9a13ae7273b5b404618))
* **gql:** add trace node and trace evaluations ([#2662](https://github.com/techthiyanes/phoenix/issues/2662)) ([a985684](https://github.com/techthiyanes/phoenix/commit/a9856847955da5a2dc00d22c4bab424049c94f77))
* **graphql:** embed project inside graphql span as private attribute ([#2522](https://github.com/techthiyanes/phoenix/issues/2522)) ([9be1afa](https://github.com/techthiyanes/phoenix/commit/9be1afa7ca9cb29698061a7fa334d2939b776456))
* Integrate `phoenix.evals` into `phoenix` ([#2420](https://github.com/techthiyanes/phoenix/issues/2420)) ([dd3e7b4](https://github.com/techthiyanes/phoenix/commit/dd3e7b4b31875572ce5e181cf3e80afecb78695c))
* launch_app() with experimental span storage using environment variables for storage path and storage type enums ([#2564](https://github.com/techthiyanes/phoenix/issues/2564)) ([8a0b572](https://github.com/techthiyanes/phoenix/commit/8a0b5729ea9a7b24d2ead37c212ae1a2839b128d))
* project archiving and deletion ([#2585](https://github.com/techthiyanes/phoenix/issues/2585)) ([121f904](https://github.com/techthiyanes/phoenix/commit/121f9047ce9fb1d9353f5275c9ae985db74fa1bf))
* **projects:** add support for the PHOENIX_PROJECT_NAME param ([#2515](https://github.com/techthiyanes/phoenix/issues/2515)) ([6f24786](https://github.com/techthiyanes/phoenix/commit/6f2478660aa6348153c11dba5dd43231a8a44df8))
* **projects:** project listing ([#2459](https://github.com/techthiyanes/phoenix/issues/2459)) ([2a19814](https://github.com/techthiyanes/phoenix/commit/2a19814dd09ea2c540e0b56baf99ae20551fa982))
* **projects:** project node interace ([#2466](https://github.com/techthiyanes/phoenix/issues/2466)) ([9d8ade0](https://github.com/techthiyanes/phoenix/commit/9d8ade0aaec53c494e5cd120910c16fd400ac526))
* Removes token processing module from `phoenix.evals` ([#2421](https://github.com/techthiyanes/phoenix/issues/2421)) ([fbd4961](https://github.com/techthiyanes/phoenix/commit/fbd496163d6cf46b3299da4ac7962b19da054bd8))
* show first non-empty project ([#2508](https://github.com/techthiyanes/phoenix/issues/2508)) ([54a2834](https://github.com/techthiyanes/phoenix/commit/54a28349ee81ef83caab3e1823b43a913cf218bf))
* **trace:** context manager to pause tracing ([#2520](https://github.com/techthiyanes/phoenix/issues/2520)) ([6bf7232](https://github.com/techthiyanes/phoenix/commit/6bf7232116ba406085957be60028c994547205d6))
* **traces:** store and query spans by project name ([#2433](https://github.com/techthiyanes/phoenix/issues/2433)) ([b8ef923](https://github.com/techthiyanes/phoenix/commit/b8ef923815255c58eda90744910e362fc407cf5e))
* **ui:** auto-expand side nav on hover ([#2458](https://github.com/techthiyanes/phoenix/issues/2458)) ([da83f69](https://github.com/techthiyanes/phoenix/commit/da83f699120db904e2d311b17bf81585d192940d))
* **ui:** copy to clipboard for prompt template etc. ([#2496](https://github.com/techthiyanes/phoenix/issues/2496)) ([9b853d0](https://github.com/techthiyanes/phoenix/commit/9b853d0a3fc62519b01d8cce1394fe61f671f9fd))
* **ui:** new side nav with projects ([#2359](https://github.com/techthiyanes/phoenix/issues/2359)) ([d8c423e](https://github.com/techthiyanes/phoenix/commit/d8c423e840c5b1f856e3788781179406c97fc845))


### Bug Fixes

* display newlines in explanations ([#2531](https://github.com/techthiyanes/phoenix/issues/2531)) ([12e8a97](https://github.com/techthiyanes/phoenix/commit/12e8a97404ac30b7348d55f46d34e952c79af93d))
* handle numpy types in json.dumps for gql ([#2600](https://github.com/techthiyanes/phoenix/issues/2600)) ([13cce4f](https://github.com/techthiyanes/phoenix/commit/13cce4fdc6de1902ce143d3cf2287acb0d6578d8))
* ignore docs/ directory when formatting ([#2714](https://github.com/techthiyanes/phoenix/issues/2714)) ([1340f74](https://github.com/techthiyanes/phoenix/commit/1340f74000d8d94aa48611881aa8885995b7745b))
* increase attributes limit on spans ([#2575](https://github.com/techthiyanes/phoenix/issues/2575)) ([94b1930](https://github.com/techthiyanes/phoenix/commit/94b1930f7655f0cea3e889adc4962a01c8acbcf6))
* link to span ([#2460](https://github.com/techthiyanes/phoenix/issues/2460)) ([cbef052](https://github.com/techthiyanes/phoenix/commit/cbef05233a22314d886d120f4df1c1065fe1fb72))
* long project names do not overflow and squash project icon ([#2686](https://github.com/techthiyanes/phoenix/issues/2686)) ([b77bfaa](https://github.com/techthiyanes/phoenix/commit/b77bfaa494d5a1d7d845b967d8a6fe6eff990b9b))
* parse files to detect sagemaker ([#2527](https://github.com/techthiyanes/phoenix/issues/2527)) ([0761513](https://github.com/techthiyanes/phoenix/commit/0761513c61e76418854881f918a04b25ef958466))
* prevent browser caching of static assets ([#2549](https://github.com/techthiyanes/phoenix/issues/2549)) ([038e56e](https://github.com/techthiyanes/phoenix/commit/038e56e242032f27ebbb46b044a8549918ca1e8a))
* project name for evals ([#2648](https://github.com/techthiyanes/phoenix/issues/2648)) ([14a3c2c](https://github.com/techthiyanes/phoenix/commit/14a3c2c2f00d848602acfcdf0530337a9d05196b))
* **projects:** the home page should direct you to the projects page if there are multiple projects with data ([#2586](https://github.com/techthiyanes/phoenix/issues/2586)) ([ced4e75](https://github.com/techthiyanes/phoenix/commit/ced4e753823e77919d10c3c88e8a2ee08eaf5d21))
* Properly define `BedrockModel` ([#2425](https://github.com/techthiyanes/phoenix/issues/2425)) ([81a720c](https://github.com/techthiyanes/phoenix/commit/81a720c8264f80fc37fcfe76c1c982014e9f12b3))
* remove __computed__ atributes from exported dataframe ([#2366](https://github.com/techthiyanes/phoenix/issues/2366)) ([1de1415](https://github.com/techthiyanes/phoenix/commit/1de1415de8938d4d583620e86394dcab607becf4))
* remove run_relevance_evals and fix import issues ([#2375](https://github.com/techthiyanes/phoenix/issues/2375)) ([9a97e62](https://github.com/techthiyanes/phoenix/commit/9a97e6251cddf4ca7aa03ba71d4831cb0de4a165))
* remove symbolic links for docker build ([#2408](https://github.com/techthiyanes/phoenix/issues/2408)) ([b57abe9](https://github.com/techthiyanes/phoenix/commit/b57abe9d6bf0352c3fc41c60727350185544ff9b))
* repair frontend build step in release pipeline  ([#2716](https://github.com/techthiyanes/phoenix/issues/2716)) ([796eb6a](https://github.com/techthiyanes/phoenix/commit/796eb6a95e039c37b8a4904df0d1c1061de0acd0))
* **sagemaker:** graphql base url was incorrect for sagemaker jupyterlab ([#2572](https://github.com/techthiyanes/phoenix/issues/2572)) ([7ecf46e](https://github.com/techthiyanes/phoenix/commit/7ecf46ee14a43010d3c9ff12eb84382633cd4b1d))
* sanitize base path ([#2573](https://github.com/techthiyanes/phoenix/issues/2573)) ([f2647a2](https://github.com/techthiyanes/phoenix/commit/f2647a2530babf4d91cf1d022f87df2584792baf))
* source distribution build ([#2407](https://github.com/techthiyanes/phoenix/issues/2407)) ([1e67d7e](https://github.com/techthiyanes/phoenix/commit/1e67d7e4eb037f85b1e33e59b42014fe3daa876d))
* support minimal llama-index installations ([#2516](https://github.com/techthiyanes/phoenix/issues/2516)) ([2469677](https://github.com/techthiyanes/phoenix/commit/246967731bb211c5a891e0720a503aa8973803df))
* support numpy arrays in span to json encoder ([#2583](https://github.com/techthiyanes/phoenix/issues/2583)) ([3a297d5](https://github.com/techthiyanes/phoenix/commit/3a297d535a769ee462b70f2a49428016bd2a3c8c))
* switch license format  in toml ([5c6f345](https://github.com/techthiyanes/phoenix/commit/5c6f345691dcab3d460823329ce31b9060bab02c))
* **trace:** eliminate truth ambiguity with non-empty numpy arrays ([#2626](https://github.com/techthiyanes/phoenix/issues/2626)) ([be8ce7d](https://github.com/techthiyanes/phoenix/commit/be8ce7dee124340521e30510d826f3973c4d4d9a))
* **trace:** query dsl for numpy arrays ([#2652](https://github.com/techthiyanes/phoenix/issues/2652)) ([33f7c73](https://github.com/techthiyanes/phoenix/commit/33f7c73ce4ed6e4b01ac5be7f54131c461b30dec))
* **trace:** redefine root span ([#2632](https://github.com/techthiyanes/phoenix/issues/2632)) ([7940c9d](https://github.com/techthiyanes/phoenix/commit/7940c9d4fbce2ec8674733e43d742411e26488c6))
* **traces:** add y scroll on trace tree ([#2399](https://github.com/techthiyanes/phoenix/issues/2399)) ([9c4f6b9](https://github.com/techthiyanes/phoenix/commit/9c4f6b9cec80709eb9f673934282ad3a7cbddc92))
* turn span_kind enums into string because it's not serializable by pyarrow ([#2438](https://github.com/techthiyanes/phoenix/issues/2438)) ([50c7eb0](https://github.com/techthiyanes/phoenix/commit/50c7eb04e70c6404992d3d829221151b860d5c9d))
* **ui:** broken context for markdown ([556e901](https://github.com/techthiyanes/phoenix/commit/556e901c7dc19ed24fbb466c12fcbe03458070ec))
* **UI:** color rotation for markdown ([3184359](https://github.com/techthiyanes/phoenix/commit/3184359487535331530000eda6e0b24f140f3530))
* **ui:** increase pagination size for TracePage ([#2642](https://github.com/techthiyanes/phoenix/issues/2642)) ([6cd456f](https://github.com/techthiyanes/phoenix/commit/6cd456fd4a4c3a9331379ee364221f4fce430c9c))
* **ui:** scroll column selector when long ([#2552](https://github.com/techthiyanes/phoenix/issues/2552)) ([cbf8df8](https://github.com/techthiyanes/phoenix/commit/cbf8df842b496a53af554552c0b3622d8353c9fd))
* **ui:** show formatted JSON for attributes ([0d1b719](https://github.com/techthiyanes/phoenix/commit/0d1b71974b26d3fec228f07837dc4c7d2cfa2e18))
* **ui:** show formatted JSON for attributes ([09ad1be](https://github.com/techthiyanes/phoenix/commit/09ad1be7c14c86ac5d68b0fc6216056591a386c3))
* update rag and llm ops notebooks ([#2442](https://github.com/techthiyanes/phoenix/issues/2442)) ([adf1b2b](https://github.com/techthiyanes/phoenix/commit/adf1b2ba7f62647d20f72bb7e88fb6ff7bfba6b1))
* use environment variable for project name ([#2590](https://github.com/techthiyanes/phoenix/issues/2590)) ([e2ace76](https://github.com/techthiyanes/phoenix/commit/e2ace76c08ba5fe20c472934c051f1682d8d7d12))


### Documentation

* Add image (GITBOOK-523) ([37cc34e](https://github.com/techthiyanes/phoenix/commit/37cc34e27b2934d63587a9f7714a1d8639912091))
* Add images at the top of instrumentations (GITBOOK-532) ([5de8129](https://github.com/techthiyanes/phoenix/commit/5de812926c2730c670f887dd745ccf2d45dde2b9))
* add links for projects (GITBOOK-574) ([ab77508](https://github.com/techthiyanes/phoenix/commit/ab7750813c09ee11fd36241ed724f2c89d3cfdae))
* Add mistral (GITBOOK-594) ([78676af](https://github.com/techthiyanes/phoenix/commit/78676afcde73da59a890f146bfc1674bdbc00716))
* add mistral instrumentation to notebook ([#2681](https://github.com/techthiyanes/phoenix/issues/2681)) ([54dc47d](https://github.com/techthiyanes/phoenix/commit/54dc47d9c745ce443e40659e8f69a2f1304b1ab1))
* add mistral instrumentor to mistral tutorial ([#2682](https://github.com/techthiyanes/phoenix/issues/2682)) ([13fc1f8](https://github.com/techthiyanes/phoenix/commit/13fc1f8a9d696b5a5087d504c32415818d120285))
* Add projects tutorial ([#2611](https://github.com/techthiyanes/phoenix/issues/2611)) ([cca0a0e](https://github.com/techthiyanes/phoenix/commit/cca0a0e1da6f16906dc2f39f33fec4cbe997f18e))
* Add Qdrant + Langchain tracing example ([#2634](https://github.com/techthiyanes/phoenix/issues/2634)) ([7f014f8](https://github.com/techthiyanes/phoenix/commit/7f014f8c29d378fbf5fe7ead8f018cf4bd262ebc))
* Add Ragas as an integration (GITBOOK-575) ([9deabdf](https://github.com/techthiyanes/phoenix/commit/9deabdf409c20dd17eaa307d5ee89925514527ae))
* Add SQL retriever tracing tutorial ([#2468](https://github.com/techthiyanes/phoenix/issues/2468)) ([c92b118](https://github.com/techthiyanes/phoenix/commit/c92b11875fb77391fd26d7595f33d164b55a8de6))
* add user guide image (GITBOOK-555) ([265b249](https://github.com/techthiyanes/phoenix/commit/265b249e1f5ccdf06269591184c8f574817929e6))
* Added how-to guide (GITBOOK-549) ([f0294e8](https://github.com/techthiyanes/phoenix/commit/f0294e8c84ad95d53327aee8f8ffbbdae3f162cb))
* Aman's Mar 11 changes (GITBOOK-550) ([b413d54](https://github.com/techthiyanes/phoenix/commit/b413d54d54b75bc56f6c68ea8c7324f68358826a))
* Aman's Mar 21 changes (GITBOOK-592) ([607650e](https://github.com/techthiyanes/phoenix/commit/607650e19f338c8a2040079052492affc05354c8))
* Change intro passage (GITBOOK-533) ([3d229aa](https://github.com/techthiyanes/phoenix/commit/3d229aae00417422b34b9efe1d48e47b685f8bec))
* Change Nav (GITBOOK-514) ([26b9e9f](https://github.com/techthiyanes/phoenix/commit/26b9e9f566cc6eaf7bb2ab9d73fa5355e6d8c0b9))
* change-slug (GITBOOK-557) ([06b20dc](https://github.com/techthiyanes/phoenix/commit/06b20dc2887fe6cf4a5abbb367fa81d170672ea9))
* clarify tab labels (GITBOOK-573) ([4b1f63b](https://github.com/techthiyanes/phoenix/commit/4b1f63be01373d9bbcbe2be23bbadeebe984c441))
* Create an Arize sub-sections (GITBOOK-590) ([d38187e](https://github.com/techthiyanes/phoenix/commit/d38187e5119aee8e5a6f1011a07991ac048902ba))
* delete obsolete exporter code (GITBOOK-525) ([16c0de5](https://github.com/techthiyanes/phoenix/commit/16c0de5972edb3a714bf2af22c4d0468cbb879c0))
* Deprecate single how-to (GITBOOK-582) ([92816d1](https://github.com/techthiyanes/phoenix/commit/92816d124f56319f0bb086f0e8f4212fd9e12c04))
* dockerize manual instrumentation example ([#2797](https://github.com/techthiyanes/phoenix/issues/2797)) ([651efbe](https://github.com/techthiyanes/phoenix/commit/651efbe56e6ce3be35b8471827d83a674b494230))
* document get_spans_dataframe (GITBOOK-569) ([d011bd8](https://github.com/techthiyanes/phoenix/commit/d011bd8bacd1621ea396f6a6e0e4e7632bec949a))
* Evals Structure! (GITBOOK-547) ([ac23311](https://github.com/techthiyanes/phoenix/commit/ac23311c37cc7cdb0f1c53a64d229a66acd2e2a6))
* **evals:** add README ([#2363](https://github.com/techthiyanes/phoenix/issues/2363)) ([47842da](https://github.com/techthiyanes/phoenix/commit/47842da560f004944852ea1071edf30eb3993ac8))
* **evals:** migrate evaluation notebooks ([#2388](https://github.com/techthiyanes/phoenix/issues/2388)) ([3dedc6e](https://github.com/techthiyanes/phoenix/commit/3dedc6ef6d21ab55f303401a5a0c25cf1b74d1d0))
* **evals:** update tracing tutorials with arize-phoenix-evals ([#2386](https://github.com/techthiyanes/phoenix/issues/2386)) ([1af8187](https://github.com/techthiyanes/phoenix/commit/1af81871b105135584959afbd7c906f9b2607db4))
* example using cron for online phoenix evals ([#2643](https://github.com/techthiyanes/phoenix/issues/2643)) ([5ea99ef](https://github.com/techthiyanes/phoenix/commit/5ea99ef8244d7b72901d6f78dc0b586d8e2a8086))
* fix Bedrock (GITBOOK-535) ([71a53af](https://github.com/techthiyanes/phoenix/commit/71a53afeec385d9cd252cc121e077c44e4468711))
* fix concat,  add custom metadata (GITBOOK-587) ([682265c](https://github.com/techthiyanes/phoenix/commit/682265cb19bfcc09dcfcd4cfa9a887be9028c362))
* fix install commands (GITBOOK-530) ([8d4f009](https://github.com/techthiyanes/phoenix/commit/8d4f00979450ec010a9ce2ece75b9b6db6d85bb4))
* fix links (GITBOOK-522) ([16eca63](https://github.com/techthiyanes/phoenix/commit/16eca6350ae40cf28e6ef15d552eaa418ce235c0))
* fix missing parentheses (GITBOOK-571) ([2353953](https://github.com/techthiyanes/phoenix/commit/2353953cd8a0185f2fd8e391c72aaf340afc1cca))
* fix missing quotes (GITBOOK-572) ([9a5112c](https://github.com/techthiyanes/phoenix/commit/9a5112c5d3fda9360308b7fddd8138508934aa64))
* fix online evals link (GITBOOK-589) ([696eac9](https://github.com/techthiyanes/phoenix/commit/696eac925001af5cb811563510f698a760c5f73a))
* fix qa with reference tutorial ([e1db1ce](https://github.com/techthiyanes/phoenix/commit/e1db1cee189e36311eb96f7473a8b496340907bc))
* fix qa with reference tutorial ([ba24950](https://github.com/techthiyanes/phoenix/commit/ba249507f24dca801a3986e6275dae5f468ef362))
* fix tracing name (GITBOOK-559) ([553a6d2](https://github.com/techthiyanes/phoenix/commit/553a6d256210db60ce82c830666b54db63472081))
* fix typo (GITBOOK-544) ([01da282](https://github.com/techthiyanes/phoenix/commit/01da2826182c2fa5739b519691926c8ea9615fde))
* fix typo (GITBOOK-566) ([a5d7f12](https://github.com/techthiyanes/phoenix/commit/a5d7f124a71afa29529dcfe9efe011ff464f80df))
* Fixed typo "grammatical" (GITBOOK-524) ([c93e047](https://github.com/techthiyanes/phoenix/commit/c93e04756918bd2ddf0f6c20cd3592975c43ce5f))
* fixed url typo (GITBOOK-528) ([05ac8be](https://github.com/techthiyanes/phoenix/commit/05ac8be5d94f3c040c9512a0aba433a5e79e9e51))
* fixing typo in "inferences" (GITBOOK-586) ([89ea4fc](https://github.com/techthiyanes/phoenix/commit/89ea4fc3e42f432ec1a8b3df110110a5591b8006))
* Improve projects-related API docstrings ([#2589](https://github.com/techthiyanes/phoenix/issues/2589)) ([9eebb00](https://github.com/techthiyanes/phoenix/commit/9eebb00ea63529ad9b12f2a4aad6716fe1088c05))
* Improve Traces Section (GITBOOK-529) ([2f3f6a4](https://github.com/techthiyanes/phoenix/commit/2f3f6a462581589e5e1f3fd02220c57ead829fd6))
* Leave a note about the containers on the landing page (GITBOOK-539) ([f067617](https://github.com/techthiyanes/phoenix/commit/f0676170779520d05e156dbb9388989d5b3f015e))
* link out to environments (GITBOOK-542) ([10b917a](https://github.com/techthiyanes/phoenix/commit/10b917a034e9d43f9919cfab08f7e9cabdb41416))
* log information about the server at startup ([#2445](https://github.com/techthiyanes/phoenix/issues/2445)) ([6d410c1](https://github.com/techthiyanes/phoenix/commit/6d410c1509e0380cd5f19cee185a1401c6d33ad2))
* make dockerhub URL go to public ([6650f67](https://github.com/techthiyanes/phoenix/commit/6650f6729117e192de9e2435ed543c01b654f2aa))
* manually instrumented chatbot ([#2730](https://github.com/techthiyanes/phoenix/issues/2730)) ([46be32b](https://github.com/techthiyanes/phoenix/commit/46be32b54438a5cc9dc26948138ddacd36699409))
* Minor cleanup (GITBOOK-578) ([ad2692e](https://github.com/techthiyanes/phoenix/commit/ad2692ecc4cb6da53e08e630bd67bf4b986d1a88))
* Mistral (GITBOOK-595) ([f245844](https://github.com/techthiyanes/phoenix/commit/f2458443df8f474ea8b238fbc0d4faa2dfe5b437))
* mistral tutorial ([#2627](https://github.com/techthiyanes/phoenix/issues/2627)) ([97d4096](https://github.com/techthiyanes/phoenix/commit/97d4096876ab2c84de5d6c1e76e073b0d9824cd7))
* More cleanup on tracing (GITBOOK-581) ([434af68](https://github.com/techthiyanes/phoenix/commit/434af6891a249cd98a4c4b55e8a14136f2040cd4))
* more project docs (GITBOOK-585) ([0c13fe5](https://github.com/techthiyanes/phoenix/commit/0c13fe50cf6af7fbf887ee4d2d049f8e0aa0fab9))
* Move more to how-to tracing (GITBOOK-580) ([9a36e37](https://github.com/techthiyanes/phoenix/commit/9a36e37ba7913cfddcb69ee9b8b82b110a7191c6))
* Nest auto and manual instrumentation in how-to (GITBOOK-558) ([14c4303](https://github.com/techthiyanes/phoenix/commit/14c43032eb9f6e3bdd69876ac3e1f934d66260bf))
* nix unnecessary config section (GITBOOK-577) ([75e5182](https://github.com/techthiyanes/phoenix/commit/75e5182fa4caf23a28430cabb0eb39f893361550))
* No subject (GITBOOK-534) ([ec0314f](https://github.com/techthiyanes/phoenix/commit/ec0314f2daaa387691ac62d23731f9993222136c))
* No subject (GITBOOK-536) ([22bae6a](https://github.com/techthiyanes/phoenix/commit/22bae6a5d6c22e8e5a71dab4db42a5640239f442))
* No subject (GITBOOK-553) ([41e0f9e](https://github.com/techthiyanes/phoenix/commit/41e0f9eca595fdd002f54c8676cc6df2b6cce854))
* No subject (GITBOOK-554) ([7fc4b5e](https://github.com/techthiyanes/phoenix/commit/7fc4b5e73ecf057ebbf7a6493d58d780a912d438))
* No subject (GITBOOK-562) ([84e3cdb](https://github.com/techthiyanes/phoenix/commit/84e3cdb7870dcef6d4bd139b065601a6893e1e86))
* No subject (GITBOOK-563) ([ae4f102](https://github.com/techthiyanes/phoenix/commit/ae4f102554b6e46bf70210edd961ab8faefb872e))
* No subject (GITBOOK-564) ([510a043](https://github.com/techthiyanes/phoenix/commit/510a043aac2c1ab0a3d4571f6c7ef6a5a66768f0))
* No subject (GITBOOK-565) ([905af06](https://github.com/techthiyanes/phoenix/commit/905af06f09f52e2004e9af0edc7075694289a593))
* No subject (GITBOOK-567) ([ea6201a](https://github.com/techthiyanes/phoenix/commit/ea6201a00e68a9a2b926f6d546e51042b2904751))
* No subject (GITBOOK-579) ([d8e8df2](https://github.com/techthiyanes/phoenix/commit/d8e8df2986f5f6aeae0ca44915bda95c5dfcf568))
* No subject (GITBOOK-591) ([4472c16](https://github.com/techthiyanes/phoenix/commit/4472c167b454f6b731036aafb4cd01fb0737ce2b))
* No subject (GITBOOK-597) ([b6196ac](https://github.com/techthiyanes/phoenix/commit/b6196ac8f7e05155f352180e712f282a1fc510d7))
* No subject (GITBOOK-598) ([f6a2bd6](https://github.com/techthiyanes/phoenix/commit/f6a2bd6491838440b05a5bfa93d83facad0e2dca))
* Online Evals (GITBOOK-561) ([659f186](https://github.com/techthiyanes/phoenix/commit/659f186d87fe96a5f8d6a507ffbf6a33e715f2d4))
* Overview revamp (GITBOOK-518) ([63a76a3](https://github.com/techthiyanes/phoenix/commit/63a76a389e09dff739ab95a731ea8e9b1233ec90))
* re-order references (GITBOOK-541) ([cca7608](https://github.com/techthiyanes/phoenix/commit/cca7608154d1535781b023d22fb8f4e71df82a1b))
* re-organize concepts and setup (GITBOOK-576) ([ddaeaa2](https://github.com/techthiyanes/phoenix/commit/ddaeaa2c7263f0dcbd728e334c2a5fab489bff1b))
* Remove experimental on evals (GITBOOK-583) ([c064923](https://github.com/techthiyanes/phoenix/commit/c0649237f6861a0bc0a109ecd4b8c89d9640b014))
* remove experimental tags in code ([4c4a832](https://github.com/techthiyanes/phoenix/commit/4c4a832adb874a151821b1ef46a709daf5091003))
* Remove pinecone notebook ([#2665](https://github.com/techthiyanes/phoenix/issues/2665)) ([9f1c1d4](https://github.com/techthiyanes/phoenix/commit/9f1c1d45b777673fe39e940415a7a9f4c8120e72))
* remove the banner (GITBOOK-540) ([1651b40](https://github.com/techthiyanes/phoenix/commit/1651b401da069b7f284b82fb39e15ecd9b1ed5b0))
* remove use-cases (GITBOOK-519) ([cbd2a5c](https://github.com/techthiyanes/phoenix/commit/cbd2a5cf5570d911d6fc23fbb785adb03fd450e5))
* Simplify Auto Instrumentation (GITBOOK-531) ([b020b99](https://github.com/techthiyanes/phoenix/commit/b020b992a755803fed541af424e6c023b1787433))
* Simplify environments (GITBOOK-520) ([7514211](https://github.com/techthiyanes/phoenix/commit/751421132da8ca95fd2954888a2be43487487af5))
* simplify llama-index (GITBOOK-543) ([c1f84aa](https://github.com/techthiyanes/phoenix/commit/c1f84aab74939af0d0e724c2edb6810a6772bc1e))
* Simplify nav (GITBOOK-548) ([b0ceb1b](https://github.com/techthiyanes/phoenix/commit/b0ceb1ba326ff001b6365498782933cdfacff0ab))
* simplify the quickstart (GITBOOK-537) ([2fa3c8a](https://github.com/techthiyanes/phoenix/commit/2fa3c8af00dbde656c990cf34b3088e8b3a561c1))
* Split out concepts fortracing (GITBOOK-546) ([e8d3fdb](https://github.com/techthiyanes/phoenix/commit/e8d3fdb08d7bc5218fc796dd261cf1fa903bbc14))
* Supported Models V1 (GITBOOK-560) ([a550dd7](https://github.com/techthiyanes/phoenix/commit/a550dd76269f48f34beffb215dde9853e764a905))
* sync Feb 21, 2024 ([#2343](https://github.com/techthiyanes/phoenix/issues/2343)) ([4e151f3](https://github.com/techthiyanes/phoenix/commit/4e151f37f0afcd5de80eae52e7650677bf3bb9e2))
* trace a deployed app (GITBOOK-593) ([08623ea](https://github.com/techthiyanes/phoenix/commit/08623eaa6354c7b70a5ac8c78ac9a5a939aefeec))
* update cron evals documentation (GITBOOK-588) ([a4ef19c](https://github.com/techthiyanes/phoenix/commit/a4ef19cdd3273dc90c4d7cb9e1e76990147f50e7))
* update install to include evals (GITBOOK-527) ([6759b67](https://github.com/techthiyanes/phoenix/commit/6759b675cae38506bc6733352cd5c52f70bbca3e))
* Update OpenAI Phoenix Traces QuickStart (GITBOOK-517) ([bf2289c](https://github.com/techthiyanes/phoenix/commit/bf2289c9104400f3a486756b02c323a48c493a01))
* Update projects section (GITBOOK-584) ([e11885f](https://github.com/techthiyanes/phoenix/commit/e11885f8083d6c5a883a8145d1097547de7f5c5e))
* Update pyproject.toml with proper biline ([4fdf710](https://github.com/techthiyanes/phoenix/commit/4fdf710057a6fd19c75df133ed28206c35597eee))
* update ragas integration ([#2400](https://github.com/techthiyanes/phoenix/issues/2400)) ([7bebe98](https://github.com/techthiyanes/phoenix/commit/7bebe98beeeb2a7ffe1eaf56edaf8f9d6b062226))
* update readme for phoenix.evals, fix llama-index example ([#2435](https://github.com/techthiyanes/phoenix/issues/2435)) ([dfffaad](https://github.com/techthiyanes/phoenix/commit/dfffaadd8bba60750680caabcfd38913c0d79a94))
* update tracing section with project info (GITBOOK-568) ([888535a](https://github.com/techthiyanes/phoenix/commit/888535a1bb8a51b70c9fe1d12a6755caea5c174e))
* use projects with ragas ([#2569](https://github.com/techthiyanes/phoenix/issues/2569)) ([1e7b31d](https://github.com/techthiyanes/phoenix/commit/1e7b31d7a17d048956732cdb8f70102d74ec6c5b))
